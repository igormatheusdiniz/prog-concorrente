...
public class Main2 {
	...
	public static void main(String[] args) {
		...
		new Thread(new Requester(server1)).start();
	...
	static class Requester implements Runnable {
		...
		public Requester(Server server) {
			this.server = server;
	...
	static class APIRequester {
		...
		public boolean request(Server serverName1) {
		...
		public void reliableRequest(Server server1) {
